		...
		<p class="heading-btm-w3ls">Las bases que fundamentan un servicio correcto para cada individuo.</p>
			<div class="blog-grid-w3-agileits">
				...
				<div class=" col-md-5 blog-info-w3layouts">
					<h6> <a  href="#" data-toggle="modal" data-target="#myModal2">PARTE DE LEGISLACIÓN 1</a></h6>
			...
			<div class="blog-grid-w3-agileits">
				<div class=" col-md-5 blog-info-w3layouts blog-mid">
					<h6><a  href="#" data-toggle="modal" data-target="#myModal3">PARTE DE LEGISLACIÓN 2</a></h6>
			...
			<div class="blog-grid-w3-agileits">
				...
				<div class=" col-md-5 blog-info-w3layouts">
					<h6><a  href="#" data-toggle="modal" data-target="#myModal4"> PARTE DE LEGISLACIÓn 3</a></h6>
					<div class="inner-info">
